...
class PanditConsultationDashboard extends StatelessWidget {
  const PanditConsultationDashboard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamProvider<List<ConsultationSession>>.value(
        value: consultationService.getPanditSessions(panditId),
        initialData: const [],
        child: const PanditConsultationList(),
      ),
    );
  }
}

class PanditConsultationList extends StatelessWidget {
  const PanditConsultationList({super.key});
